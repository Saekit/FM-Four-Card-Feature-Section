const TeamBuilderIcon = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={64} height={64} {...props}>
    <g fill="none">
      ...
      <path
        fill="#FF637B"
        d="M7.758 5.818h3.685v3.879H7.758zm7.37 0h3.685v3.879h-3.685zm7.369 0h3.685v3.879h-3.685zM45.576 42.245V64H34.355v-3.71h-3.74V64H19.394V42.245l11.37-9.275h3.105z"
      />
      ...
      <path
        fill="#676E74"
        d="m50.424 45.779-2.452 2.706-15.487-13.526-15.488 13.526-2.452-2.706 17.94-15.718z"
      />
      <path
        fill="#474F54"
        d="m32 30.061 18.424 15.718-2.518 2.706L32 34.959z"
      />
    </g>
  </svg>
);
