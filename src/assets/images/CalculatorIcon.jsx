const CalculatorIcon = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={64} height={64} {...props}>
    <g fill="none">
      ...
      <path
        fill="#549EF2"
        d="M20.75 7.5c-7.236 0-13.125 5.889-13.125 13.125S13.514 33.75 20.75 33.75s13.125-5.889 13.125-13.125S27.986 7.5 20.75 7.5zm0 18.75a5.631 5.631 0 0 1-5.625-5.625A5.631 5.631 0 0 1 20.75 15a5.631 5.631 0 0 1 5.625 5.625 5.631 5.631 0 0 1-5.625 5.625z"
      />
      <path
        fill="#377FD2"
        d="M45.125 7.5H56.5v3.75H45.125zm-7.5 0h3.75v3.75h-3.75zm7.5 15H56.5v3.75H45.125zm-7.5 0h3.75v3.75h-3.75zm0-7.5H56.5v3.75H37.625zm0 15H56.5v3.75H37.625z"
      />
    </g>
  </svg>
);
